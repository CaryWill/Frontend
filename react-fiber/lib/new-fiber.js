...
function tick() {
  ...
  const clockElement = Didact.createElement("div", null, Didact.createElement("span", null, "Date: "), Didact.createElement("h1", null, time), Didact.createElement(Counter, null)); // 之前在做 partial diff 的时候，我们的 `element`(vnode) 不够用了
